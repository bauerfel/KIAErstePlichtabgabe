...
def load_mnist_model():
    ...
    model_filename = os.path.join(os.path.dirname(os.path.abspath(__file__)), "linear_regression.pkl")
...
def predict():
    ...
    model_filename = os.path.join(os.path.dirname(os.path.abspath(__file__)), "random_forest.pkl")
    with open(model_filename, 'rb') as f:
